...
function loadWMS(map, baseURL, customParams){
    ...
    var overlayOptions =
    {
        getTileUrl: function(coord, zoom)
        {
            ...
            //var lUL = meters2degrees(lUL_Longitude, lUL_Latitude);
            //var lLR = meters2degrees(lLR_Longitude, lLR_Latitude);
            var urlResult = baseURL + wmsParams.join("&") + "&bbox=" + lUL_Longitude + "," + lUL_Latitude + "," + lLR_Longitude + "," + lLR_Latitude;
            //var urlResult = baseURL + wmsParams.join("&") + "&bbox=" + lUL[0] + "," + lUL[1] + "," + lLR[0] + "," + lLR[1];
